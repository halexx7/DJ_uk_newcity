...
class User(AbstractBaseUser, PermissionsMixin):
    is_client = models.BooleanField(default=True, verbose_name="Пользователь",
                                    help_text="Если это житель поставьте галку."
                                    )
    is_staff = models.BooleanField(default=False, verbose_name="Менеджер",
                                   help_text="Обозначает, что этот пользователь - Администратор"
                                   )
    personal_account = models.CharField(max_length=128, verbose_name="Лицевой счет", 
                                        unique=True, help_text="Введите номер лицевого счета: 777777",
                                        validators=[
                                            RegexValidator(r'\d',
                                            "Лицевой счет состоит только из цифр!"),
                                            MinLengthValidator(6,
                                            "Лицевой счет состоит из 6 цифр. Вы ввели меньше."),
                                            MaxLengthValidator(6,
                                            "Лицевой счет состоит из 6 цифр. Вы ввели больше.")])
    password = models.CharField(verbose_name="Пароль", max_length=128)
    name = models.CharField(verbose_name="ФИО", max_length=128, null=True,
                            blank=True, help_text="Иванов Иван Иванович",
                            validators=[
                                RegexValidator(r'^[a-zA-Zа-яА-ЯёЁ]*$',
                                'Cпециальные символы и цифры не допускаются!'),
    ...
    phone = models.CharField(verbose_name="Телефон", max_length=11, null=True, blank=True, 
                             ...
                             validators=[
                                 ...
                                 "Телефон состоит только из цифр!"),
                                 MinLengthValidator(11,
                                 "Телефон состоит из 11 цифр. Вы ввели меньше."),
                                 MaxLengthValidator(11,
                                 "Телефон состоит из 11 цифр. Вы ввели больше.")])
