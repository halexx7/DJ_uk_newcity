    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=128, null=True, verbose_name='ФИО')),
                ...
                ('activation_key_expires', models.DateTimeField(default=datetime.datetime(2021, 4, 16, 12, 9, 37, 37057, tzinfo=utc), verbose_name='Актуальность ключа')),
