    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='Включено')),
                ('number', models.CharField(max_length=3, validators=[mainapp.mixins.validator.check_value_is_digit], verbose_name='Номер квартиры')),
                ('add_number', models.CharField(default=0, max_length=3, validators=[mainapp.mixins.validator.check_value_is_digit], verbose_name='Комната')),
