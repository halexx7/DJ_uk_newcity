...
from apps.directory.models import (Appartament, City, House, Metrics, PostNews, Privileges, Services,
                              ServicesCategory, Street, Subsidies, UserProfile)
from apps.mainapp.models import (AverageСalculationBuffer, ConstantPayments, CurrentCounter, HeaderData,
