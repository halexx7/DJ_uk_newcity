# Generated by Django 2.2.24 on 2022-02-02 19:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 19, 44, 22, 842335), verbose_name='Период')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='Включено')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 19, 44, 22, 840056), verbose_name='Период')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='Включено')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 19, 44, 22, 841442), verbose_name='Период')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='Включено')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 19, 44, 22, 843741), verbose_name='Период')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='Включено')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 19, 44, 22, 843200), verbose_name='Период')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 19, 44, 22, 839597), verbose_name='Период')),
                ('house', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='directory.House', verbose_name='Дом')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('col_water', models.DecimalField(decimal_places=3, default=None, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.001)], verbose_name='Холодная вода')),
                ('hot_water', models.DecimalField(decimal_places=3, default=None, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.001)], verbose_name='Горячая вода')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 19, 44, 22, 839186), verbose_name='Период')),
                ('house', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='directory.House', verbose_name='Дом')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('col_water', models.DecimalField(decimal_places=3, default=None, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.001)], verbose_name='Холодная вода')),
                ('hot_water', models.DecimalField(decimal_places=3, default=None, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.001)], verbose_name='Горячая вода')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 19, 44, 22, 840998), verbose_name='Период')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('col_water', models.DecimalField(decimal_places=3, default=None, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.001)], verbose_name='Холодная вода')),
                ('hot_water', models.DecimalField(decimal_places=3, default=None, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.001)], verbose_name='Горячая вода')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 19, 44, 22, 840606), verbose_name='Период')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Создан')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 19, 44, 22, 844749), verbose_name='Период')),
