    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 22, 7, 29, 878623), verbose_name='Период')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='Включено')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 22, 7, 29, 876456), verbose_name='Период')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='Включено')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 22, 7, 29, 877701), verbose_name='Период')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='Включено')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 22, 7, 29, 879892), verbose_name='Период')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='Включено')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 22, 7, 29, 879408), verbose_name='Период')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 22, 7, 29, 876037), verbose_name='Период')),
                ('house', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='directory.House', verbose_name='Дом')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('col_water', models.DecimalField(decimal_places=3, default=None, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.001)], verbose_name='Холодная вода')),
                ('hot_water', models.DecimalField(decimal_places=3, default=None, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.001)], verbose_name='Горячая вода')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 22, 7, 29, 875597), verbose_name='Период')),
                ('house', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='directory.House', verbose_name='Дом')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('col_water', models.DecimalField(decimal_places=3, default=None, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.001)], verbose_name='Холодная вода')),
                ('hot_water', models.DecimalField(decimal_places=3, default=None, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.001)], verbose_name='Горячая вода')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 22, 7, 29, 877282), verbose_name='Период')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('col_water', models.DecimalField(decimal_places=3, default=None, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.001)], verbose_name='Холодная вода')),
                ('hot_water', models.DecimalField(decimal_places=3, default=None, max_digits=8, null=True, validators=[django.core.validators.MinValueValidator(0.001)], verbose_name='Горячая вода')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 22, 7, 29, 876900), verbose_name='Период')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Создан')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('period', models.DateField(default=datetime.datetime(2022, 2, 1, 22, 7, 29, 880916), verbose_name='Период')),
