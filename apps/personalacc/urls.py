...
import apps.personalacc.views as personalacc
from apps.personalacc.apps import PersonalaccConfig
...
urlpatterns = [
    ...
    # Autocomplete
    re_path(r"^manager/autocomplete/$", personalacc.UserAutocomplete.as_view(), name="autocomplete"),
    ...
    re_path(
        r"^manager/privileges_history/$", personalacc.PrivilegesHistoryListView.as_view(), name="privileges_history"
    ),
