...
import apps.authnapp.views as authnapp
from apps.authnapp.apps import AuthnappConfig
from apps.authnapp.views import ProfileUpdateView

from apps.authnapp.forms import MyPassResetForm, MyPassSetForm, MyPasswordChangeForm
