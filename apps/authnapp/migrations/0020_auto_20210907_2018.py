...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authnapp', '0019_auto_20210907_1925'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2021, 9, 9, 20, 18, 19, 588850, tzinfo=utc), verbose_name='Актуальность ключа'),
        ),
        migrations.AlterField(
            model_name='user',
            name='name',
