# Generated by Django 2.2.17 on 2021-04-14 12:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Создан')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('appartament', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mainapp.Appartament', verbose_name='Квартира')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mainapp.Services', verbose_name='Услуга')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mainapp.UserProfile', verbose_name='Пользователь')),
            ],
            options={
