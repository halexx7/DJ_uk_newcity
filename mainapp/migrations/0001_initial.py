# Generated by Django 2.2.17 on 2021-04-16 01:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользоваель')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('col_water', models.PositiveIntegerField(null=True, verbose_name='Хол.вода')),
                ('hot_water', models.PositiveIntegerField(null=True, verbose_name='Гор.вода')),
                ('electric_day', models.PositiveIntegerField(blank=True, default='', null=True, verbose_name='Электр.день')),
                ('electric_night', models.PositiveIntegerField(blank=True, default='', null=True, verbose_name='Электр.ночь')),
                ('electric_single', models.PositiveIntegerField(blank=True, default='', null=True, verbose_name='Электр.однотариф')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Создан')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
