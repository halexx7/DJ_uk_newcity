    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "standart",
                    models.DecimalField(
                        blank=True, decimal_places=4, default="", max_digits=8, verbose_name="Норматив"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "appartament",
                    models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to="mainapp.Appartament"),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "standart",
                    models.DecimalField(
                        blank=True, decimal_places=4, default="125", max_digits=8, verbose_name="Норматив"
                    ),
                ),
                ("rate", models.DecimalField(decimal_places=3, default=0, max_digits=7, verbose_name="Тариф")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="mainapp.UserProfile", unique=True
                    ),
                ),
            ],
        ),
