    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "city",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="mainapp.City", verbose_name="Город"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period",
                    models.DateField(default=datetime.datetime(2021, 6, 1, 11, 43, 10, 734372), verbose_name="Создан"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("1", "однотарифный"), ("2", "двухтарифный")],
                        default=None,
                        max_length=1,
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "service",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="mainapp.Services", verbose_name="Услуга"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period",
                    models.DateField(default=datetime.datetime(2021, 6, 1, 11, 43, 10, 726539), verbose_name="Создан"),
                ),
                ...
                (
                    "electric_day",
                    models.DecimalField(
                        decimal_places=2, default=None, max_digits=6, null=True, verbose_name="Норматив ЭЛ.День"
                    ),
                ),
                (
                    "electric_night",
                    models.DecimalField(
                        decimal_places=2, default=None, max_digits=6, null=True, verbose_name="Нориматив ЭЛ.Ночь"
                    ),
                ),
                ("created", models.DateTimeField(auto_now_add=True, verbose_name="Создан")),
                ("updated", models.DateTimeField(auto_now=True, verbose_name="Обновлен")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period",
                    models.DateField(default=datetime.datetime(2021, 6, 1, 11, 43, 10, 731075), verbose_name="Создан"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period",
                    models.DateField(default=datetime.datetime(2021, 6, 1, 11, 43, 10, 736997), verbose_name="Создан"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period",
                    models.DateField(default=datetime.datetime(2021, 6, 1, 11, 43, 10, 738125), verbose_name="Создан"),
                ),
                (
                    "direction",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period",
                    models.DateField(default=datetime.datetime(2021, 6, 1, 11, 43, 10, 725485), verbose_name="Создан"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period",
                    models.DateField(default=datetime.datetime(2021, 6, 1, 11, 43, 10, 724508), verbose_name="Создан"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period",
                    models.DateField(default=datetime.datetime(2021, 6, 1, 11, 43, 10, 730217), verbose_name="Создан"),
                ),
                ...
                (
                    "electric_single",
                    models.PositiveIntegerField(blank=True, null=True, verbose_name="Электр.однотариф"),
                ),
                ("created", models.DateTimeField(auto_now_add=True, verbose_name="Создан")),
                ("updated", models.DateTimeField(auto_now=True, verbose_name="Обновлен")),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period",
                    models.DateField(default=datetime.datetime(2021, 6, 1, 11, 43, 10, 729525), verbose_name="Создан"),
                ),
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, default=None, null=True, verbose_name="Электроэнергия день"
                    ),
                ),
                (
                    "electric_night",
                    models.PositiveIntegerField(
                        blank=True, default=None, null=True, verbose_name="Электроэнергия ночь"
                    ),
                ),
                (
                    "electric_single",
                    models.PositiveIntegerField(blank=True, default=None, null=True, verbose_name="Электроэнергия"),
                ),
                ("created", models.DateTimeField(auto_now_add=True, verbose_name="Создан")),
                ("updated", models.DateTimeField(auto_now=True, verbose_name="Обновлен")),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "num_owner",
                    models.PositiveIntegerField(blank=True, default=0, null=True, verbose_name="Кол-во проживающих"),
                ),
                ("is_active", models.BooleanField(db_index=True, default=True, verbose_name="Активный")),
                ("created", models.DateTimeField(auto_now_add=True, verbose_name="Создан")),
                ("updated", models.DateTimeField(auto_now=True, verbose_name="Обновлен")),
                (
                    "house",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="mainapp.House", verbose_name="Дом"
                    ),
                ),
                (
                    "user",
