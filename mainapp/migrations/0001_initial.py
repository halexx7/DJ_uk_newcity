# Generated by Django 2.2.17 on 2021-04-23 17:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "coefficient",
                    models.DecimalField(decimal_places=2, default=1, max_digits=3, verbose_name="Коэфициент"),
                ),
                ...
                (
                    "recalculations",
                    models.DecimalField(decimal_places=2, default=0, max_digits=6, verbose_name="Перерасчет"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "street",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="mainapp.Street", verbose_name="Улица"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="unit",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="mainapp.Metrics", verbose_name="Единицы"
            ),
        ),
        migrations.CreateModel(
            name="Recalculations",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period",
                    models.DateField(default=datetime.datetime(2021, 4, 1, 17, 17, 42, 992545), verbose_name="Создан"),
                ),
                ("col_water", models.PositiveIntegerField(null=True, verbose_name="Хол.вода")),
                ("hot_water", models.PositiveIntegerField(null=True, verbose_name="Гор.вода")),
                ("electric_day", models.PositiveIntegerField(null=True, verbose_name="Электр.день")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period",
                    models.DateField(default=datetime.datetime(2021, 4, 1, 17, 17, 42, 991776), verbose_name="Создан"),
                ),
                ("col_water", models.PositiveIntegerField(null=True, verbose_name="Хол.вода")),
                ("hot_water", models.PositiveIntegerField(null=True, verbose_name="Гор.вода")),
                ("electric_day", models.PositiveIntegerField(null=True, verbose_name="Электр.день")),
        ...
        migrations.AddField(
            ...
            name="uk",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="mainapp.UK", verbose_name="Управляющая компания"
            ),
        ),
        migrations.CreateModel(
            name="HistoryCounter",
            fields=[
                ...
                (
                    "hist_electric_day",
                    models.PositiveIntegerField(blank=True, default="", null=True, verbose_name="Электр.день"),
                ),
                (
                    "hist_electric_night",
                    models.PositiveIntegerField(blank=True, default="", null=True, verbose_name="Электр.ночь"),
                ),
                (
                    "electric_single",
                    models.PositiveIntegerField(blank=True, default="", null=True, verbose_name="Электр.однотариф"),
                ),
                ("created", models.DateTimeField(auto_now_add=True, verbose_name="Создан")),
                ("updated", models.DateTimeField(auto_now=True, verbose_name="Обновлен")),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "electric_day",
                    models.PositiveIntegerField(blank=True, default="", null=True, verbose_name="Электроэнергия день"),
                ),
                (
                    "electric_night",
                    models.PositiveIntegerField(blank=True, default="", null=True, verbose_name="Электроэнергия ночь"),
                ),
                (
                    "electric_single",
                    models.PositiveIntegerField(
                        blank=True, default="", null=True, verbose_name="Электроэнергия однотариф"
                    ),
                ),
                ("created", models.DateTimeField(auto_now_add=True, verbose_name="Создан")),
                ("updated", models.DateTimeField(auto_now=True, verbose_name="Обновлен")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "add_number",
                    models.CharField(blank=True, default="-", max_length=2, null=True, verbose_name="Комната"),
                ),
