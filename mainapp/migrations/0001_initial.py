# Generated by Django 2.2.17 on 2021-04-21 11:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_electric_meter', models.CharField(blank=True, choices=[('1', 'однотарифный'), ('2', 'двухтарифный'), ('3', 'многотарифный')], max_length=1, verbose_name='Тип счетчика')),
                ('is_active', models.BooleanField(db_index=True, default=True, verbose_name='Активный')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Создан')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('appartament', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mainapp.Appartament', verbose_name='Квартира')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.City', verbose_name='Город')),
                ('street', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.Street', verbose_name='Улица')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.UserProfile', verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('period', models.DateField(auto_now_add=True, verbose_name='Период')),
        ...
        migrations.AddField(
            model_name='services',
            name='category',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='mainapp.ServicesCategory', verbose_name='Категория'),
        ),
        migrations.AddField(
            model_name='services',
            name='unit',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('period', models.DateField(default=datetime.datetime(2021, 4, 1, 11, 23, 52, 259865), verbose_name='Создан')),
                ('col_water', models.PositiveIntegerField(null=True, verbose_name='Хол.вода')),
                ('hot_water', models.PositiveIntegerField(null=True, verbose_name='Гор.вода')),
                ('electric_day', models.PositiveIntegerField(null=True, verbose_name='Электр.день')),
                ('electric_night', models.PositiveIntegerField(null=True, verbose_name='Электр.ночь')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('period', models.DateField(default=datetime.datetime(2021, 4, 1, 11, 23, 52, 259200), verbose_name='Создан')),
                ('col_water', models.PositiveIntegerField(null=True, verbose_name='Хол.вода')),
                ('hot_water', models.PositiveIntegerField(null=True, verbose_name='Гор.вода')),
                ('electric_day', models.PositiveIntegerField(null=True, verbose_name='Электр.день')),
                ('electric_night', models.PositiveIntegerField(null=True, verbose_name='Электр.ночь')),
        ...
        migrations.AddField(
            model_name='house',
            name='street',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.Street', verbose_name='Улица'),
        ),
        migrations.AddField(
            model_name='house',
            name='uk',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.UK', verbose_name='Управляющая компания'),
        ),
        migrations.CreateModel(
            name='HistoryCounter',
            fields=[
                ...
                ('hist_electric_day', models.PositiveIntegerField(blank=True, default='', null=True, verbose_name='Электр.день')),
                ('hist_electric_night', models.PositiveIntegerField(blank=True, default='', null=True, verbose_name='Электр.ночь')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('col_water', models.PositiveIntegerField(null=True, verbose_name='Холодная вода')),
                ('hot_water', models.PositiveIntegerField(null=True, verbose_name='Горячая вода')),
                ('electric_day', models.PositiveIntegerField(blank=True, default='', null=True, verbose_name='Электроэнергия день')),
                ('electric_night', models.PositiveIntegerField(blank=True, default='', null=True, verbose_name='Электроэнергия ночь')),
                ('electric_single', models.PositiveIntegerField(blank=True, default='', null=True, verbose_name='Электроэнергия однотариф')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Создан')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Обновлен')),
